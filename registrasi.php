...
<div class="daftar">
        ...
        <div class="form-group">
            ...
            <div class="form-group">
                <label for=""></label>
                <input type="text" id="" placeholder="Alamat Lengkap" name="" required>
            </div>
            <div class="form-group">
                <label for=""></label>
                <input type="text" id="" placeholder="Nomor Telepon" name="" required>
            </div>
            <div class="form-group">
                <label for=""></label>
                <input type="text" id="" placeholder="Email" name="" required>
            </div>
            <div class="form-group">
                <label for=""></label>
                <input type="password" id="" placeholder="Kata Sandi" name="" required>
            </div>
            <div class="form-group">
